    ...
    <ul>
      <li className="about-page__point">
        ...
        <p className="about-page__content">
          Shrinc is the new way to access talking therapies, quickly and easily
        </p>
      </li>
      <li className="about-page__point">
        Our Vision
      ...
      <li className="about-page__point">
        Review system
        <p className="about-page__content">
          All therapists are verified for their qualifications and professional
          accreditation. There is a review system that allows Shrinc customers
          to leave feedback of their experience. All reviews are moderated, with
          negative reviews handled discreetly by Shrinc administrators.
          Therapists with more than 3 negative reviews in any six month period
          are reviewed by Shrinc administrators and removed from the database if
          necessary.
        </p>
      </li>
      <li className="about-page__point">
